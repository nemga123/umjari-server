...
class SecurityConfig(
    ...
    fun securityFilterChain(httpSecurity: HttpSecurity): SecurityFilterChain {
        httpSecurity
            ...
            .requestMatchers(
                ...
                AntPathRequestMatcher("/api/v1/concert/{\\d+}/comments/", "GET"),
                ...
                AntPathRequestMatcher("/api/v1/user/profile-name/**/interest-music/", "GET"),
            ...
            .requestMatchers(
                ...
                AntPathRequestMatcher("/api/v1/concert/{\\d+}/comments/{\\d+}/", "DELETE"),
                AntPathRequestMatcher("/api/v1/concert/{\\d+}/comments/{\\d+}/", "PUT"),
                AntPathRequestMatcher("/api/v1/concert/{\\d+}/comments/", "POST"),
                AntPathRequestMatcher("/api/v1/group/{\\d+}/qna/", "POST"),
                AntPathRequestMatcher("/api/v1/group/{\\d+}/qna/{\\d+}/", "PUT"),
                AntPathRequestMatcher("/api/v1/group/{\\d+}/qna/{\\d+}/", "DELETE"),
                AntPathRequestMatcher("/api/v1/group/{\\d+}/qna/{\\d+}/reply/", "POST"),
                AntPathRequestMatcher("/api/v1/group/{\\d+}/qna/{\\d+}/reply/{\\d+}/", "PUT"),
                AntPathRequestMatcher("/api/v1/group/{\\d+}/qna/{\\d+}/reply/{\\d+}/", "DELETE"),
                ...
                AntPathRequestMatcher("/api/v1/user/interest-music/", "PUT"),
    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        val configuration = CorsConfiguration().also { configuration ->
